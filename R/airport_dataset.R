...
#
#  Reads results of airport specific data analysis
#

airport_distr = read.csv(paste(dataset_location, "airport_distr.csv", sep='')) 
...
total_amount_by_airport = read.csv(paste(dataset_location, "total_amount_by_airport.csv", sep='')) 
